const CACHE="edan-tabasco-v40";
const PRECACHE=["./", "./index.html", "./manifest.webmanifest", "./assets/apple-touch-icon.png", "./assets/favicon-32.png", "./assets/form_step1.jpg", "./assets/form_step6.jpg", "./assets/form_step7.jpg", "./assets/icon-192.png", "./assets/icon-512.png", "./assets/icon-edan-original.png", "./assets/icon-maskable-512.png", "./assets/inicio-edan.jpg", "./assets/logo.png", "./assets/m1.jpg", "./assets/m2.jpg", "./assets/m3.jpg", "./assets/m4_main.jpg", "./assets/m4_quality.jpg", "./assets/m5_case.jpg", "./assets/m5_priority.jpg", "./assets/m6_glance.jpg", "./assets/m6_quality.jpg", "./assets/m6_report.jpg"];
